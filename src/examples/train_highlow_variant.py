...
from src.networks.HighLowPassNet_variant import HighLowPassNet
...
print("predict train")
train_predict = model.predict(y_dirty, batch_size=batch_size, callbacks=[])
print("predict test")
